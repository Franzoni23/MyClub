...
class TelaCadastraPartida(TelaAbstract):
    ...
    def configura(self, dados_partida, jogadores, presentes):
        ...
        layout = [
            ...
            [sg.Text('Família Franzoni', size=(15, 1)), sg.InputText(dados_partida['gols_mandante'], size =(2,1), key='2'), sg.Text(' x ', size=(2, 1)), sg.InputText(dados_partida['gols_adversario'], size =(2,1), key='3'), sg.Text(' ', size=(2, 1)), sg.InputText(dados_partida['adversario'], size=(15, 1), key='1')],
            [sg.Text('')],
            [sg.Text('              Plantel'), sg.Text('                           Presentes')],
            [sg.Listbox(values=(jogadores), size=(43, 28), font='Fixedsys 15', key='jogador'), sg.Listbox(values=(presentes), size=(43, 28), font='Fixedsys 15', key='presente')],
        ...
        self.__window = sg.Window('Partidas', element_justification='left', size=(800, 850),
                                  font='Arial 24').Layout(layout)
