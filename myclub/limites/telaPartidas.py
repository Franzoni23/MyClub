...
class TelaPartidas(TelaAbstract):
    ...
    def configura(self, partidas):
        ...
        layout = [
            ...
            [sg.Listbox(values=(partidas), size=(140, 44), font='Fixedsys 15', pad=(None), key='partida')],
        ...
        self.__window = sg.Window('Partidas', element_justification='l', size=(800, 850), icon='icon.ico').Layout(layout)
